export const EVENT_GET_VIDEO_INFO = "event-get-video-info";
export const EVENT_GET_DOWNLOADS_PATH = "event-get-downloads-path";
export const EVENT_OPEN_DIR_DIALOG = "event-open-dir-dialog";
